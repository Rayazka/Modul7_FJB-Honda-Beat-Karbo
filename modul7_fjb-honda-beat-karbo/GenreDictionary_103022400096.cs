...
namespace modul7_fjb_honda_beat_karbo
{
    ...
    internal class GenreDictionary_103022400096
    {
        public GenreDictionary GenreDictionary { get; set; }

        public void ReadJSON()
        {
            string path = "D:\\temp\\modul7_fjb-honda-beat-karbo\\modul7_fjb-honda-beat-karbo\\jurnal7_3_103022400096.json";
            string jsonString = System.IO.File.ReadAllText(path);
            GenreDictionary_103022400096 genreDict = System.Text.Json.JsonSerializer.Deserialize<GenreDictionary_103022400096>(jsonString);
