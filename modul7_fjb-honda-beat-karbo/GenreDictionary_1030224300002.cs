...
namespace modul7_fjb_honda_beat_karbo
{
    ...
    internal class GenreDictionary_103022430002
    {
        public GenreDictionary GenreDictionary { get; set; }

        public void ReadJSON()
        {
            string path = "D:\\Modul7_FJB-Honda-Beat-Karbo\\modul7_fjb-honda-beat-karbo\\jurnal7_3_103022430002.json";
            string jsonString = System.IO.File.ReadAllText(path);
            GenreDictionary_103022430002 genreDict = System.Text.Json.JsonSerializer.Deserialize<GenreDictionary_103022430002>(jsonString);
